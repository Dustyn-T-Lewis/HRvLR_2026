...
F02_AUDIT <- list()
source(here("05_Figures", "F02_proteome", "a_script", "setup.R"))
...
panel_dir <- here("05_Figures", "F02_proteome", "a_script", "panels")
for (p in c(
...
source(here("05_Figures", "F02_proteome", "a_script", "composite.R"))
