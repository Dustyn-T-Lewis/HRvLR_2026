...
render_concordance_figure <- function(cfg) {
  source(here("04_Figures", "F00_PILOT", "concordance_training", "a_script", "style.R"))
  source(here("04_Figures", "F00_PILOT", "concordance_training", "a_script", "pathway_utils.R"))
  source(here("04_Figures", "F00_PILOT", "concordance_training", "a_script", "concordance.R"))
