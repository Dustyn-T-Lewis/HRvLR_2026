...
wb <- here(
  "04_Figures", "F03_pathway", "supp", "concordance_training", "c_data",
...
- `04_Figures/F03_pathway/c_data/F03_pathway_source_data.xlsx` (sheet `fgsea_all`) — the fgsea
...
Writes, under `04_Figures/F03_pathway/supp/concordance_training/`: `b_reports/panels/` and `b_reports/supp/` (PNG +
...
named `padj` in `04_Figures/F03_pathway/a_script/rings.R`, a few lines from a
