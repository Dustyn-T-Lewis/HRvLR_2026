...
wb <- here(
  "04_Figures", "F03_pathway", "supp", "concordance_acute", "c_data",
...
- `04_Figures/F03_pathway/c_data/F03_pathway_source_data.xlsx` (sheet `fgsea_all`) — the fgsea cache,
  computed once in F03 and reused so no permutation test reruns.

Writes, under `04_Figures/F03_pathway/supp/concordance_acute/`: panel and supplementary PNG + PDF, one `c_data/*.csv`
...
`04_Figures/F03_pathway/a_script/rings.R`, a few lines from a genuine fgsea BH q-value. The
