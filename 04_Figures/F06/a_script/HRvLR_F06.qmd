...
The earlier figures test proteins one at a time against a contrast we chose. F06
...
`phenotype.csv`, and the bundled `F06_source_data.xlsx`. Panels land in
...
![F06 composite. A the WGCNA module–trait association atlas; B module-level NES scatters.](../b_reports/F06_composite.png)
...
the single most interesting pattern in F06 and it is biologically sensible: an acute
