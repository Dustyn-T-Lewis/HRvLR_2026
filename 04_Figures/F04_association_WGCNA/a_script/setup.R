...
source(here("04_Figures", "F04_association_WGCNA", "a_script", "enrichment.R"))
source(here("03_DEP", "contrasts.R"))

RPT_DIR <- here("04_Figures", "F04_association_WGCNA", "b_reports")
DAT_DIR <- here("04_Figures", "F04_association_WGCNA", "c_data")
