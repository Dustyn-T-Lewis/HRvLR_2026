...
The **F06 module eigengenes were not built inside the cross-validation
...
(`d_mcsa`) predicted from the F06 module eigengenes under the elastic net, in
...
built, even though its outcome label was never seen. The F06 eigengenes are
