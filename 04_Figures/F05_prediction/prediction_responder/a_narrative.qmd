...
scores (primary), individual proteins, and the F04_association/WGCNA module eigengenes —
...
metrics <- map_dfr(phases, function(ph) {
  read_csv(
    here(
      "04_Figures", "F05_prediction", "prediction_responder", ph, "c_data",
      "class_metrics.csv"
    ),
...
The F04_association/WGCNA module eigengenes used here were built by running WGCNA **once, on all
