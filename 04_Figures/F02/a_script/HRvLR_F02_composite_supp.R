...
composite <- (panel("panel_c_cv") | panel("panel_d_cv_transitions") | panel("panel_e_intra_variability")) /
  ...
  plot_annotation(
    ...
    subtitle = "Inter-/intra-individual variability and nominal-p (< 0.05) HR-vs-LR overlap",
    theme = theme(
...
ggsave(file.path(RPT, "F02_composite_supp.pdf"), composite,
  width = 420, height = 280, units = "mm", device = PDF_DEVICE, bg = "white"
)
