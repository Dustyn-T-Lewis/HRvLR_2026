# panel_A.R — Training_HR Volcano + Ring
# Contrast: Training_HR
...
p <- make_volcano_ring(
  ...
  contrast_title     = "Training Response \u2014 HR",
  contrast_subtitle  = "HR: T2 \u2212 T1 (72h post-training)",
...
save_panel(p, file.path(RPT, "panel_A_Training_HR_MAIN"), PW, PH)
...
dep_df |>
  ...
  write_csv(file.path(DAT, "panel_A", paste0("volcano_Training_HR.csv")))

message("Panel A done: Training_HR")
