# panel_B.R — Training_LR Volcano + Ring
# Contrast: Training_LR
...
p <- make_volcano_ring(
  ...
  contrast_title     = "Training Response \u2014 LR",
  contrast_subtitle  = "LR: T2 \u2212 T1 (72h post-training)",
...
save_panel(p, file.path(RPT, "panel_B_Training_LR_MAIN"), PW, PH)
...
dep_df |>
  ...
  write_csv(file.path(DAT, "panel_B", paste0("volcano_Training_LR.csv")))

message("Panel B done: Training_LR")
