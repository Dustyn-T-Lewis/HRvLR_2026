# panel_C.R — Acute_HR Volcano + Ring
# Contrast: Acute_HR
...
p <- make_volcano_ring(
  ...
  contrast_title     = "Acute Response \u2014 HR",
  contrast_subtitle  = "HR: T3 \u2212 T1 (1h acute bout)",
...
save_panel(p, file.path(RPT, "panel_C_Acute_HR_MAIN"), PW, PH)
...
dep_df |>
  ...
  write_csv(file.path(DAT, "panel_C", paste0("volcano_Acute_HR.csv")))

message("Panel C done: Acute_HR")
