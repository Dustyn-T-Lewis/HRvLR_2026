# style.R — HRvLR F04 style definitions
# Local figure contract for volcano-ring panels and concordance utilities.
...
STATE_CONTRASTS <- c("Baseline_HRvLR", "Trained_HRvLR", "Acute_HRvLR")
CHANGE_CONTRASTS <- c("Training_HR", "Training_LR", "Acute_HR", "Acute_LR")
INTERACTION_CONTRASTS <- c("Training_Interaction", "Acute_Interaction")

MAIN_CONTRASTS <- c(STATE_CONTRASTS, CHANGE_CONTRASTS)
SUPP_CONTRASTS <- INTERACTION_CONTRASTS
CONTRASTS <- c(MAIN_CONTRASTS, SUPP_CONTRASTS)

CTR_SHORT <- c(
  Baseline_HRvLR        = "Base",
  Trained_HRvLR         = "Trained",
  Acute_HRvLR           = "Ac.State",
  Training_HR           = "Trn_HR",
  Training_LR           = "Trn_LR",
  Acute_HR              = "Acu_HR",
  Acute_LR              = "Acu_LR",
