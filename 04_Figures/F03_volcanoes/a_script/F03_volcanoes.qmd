...
trained, and acute states. each ring keyed to a family palette so a reader never mistakes one kind of comparison
for another.
...
|---|---|---|---|
| **Main** (A–C) | HR and LR proteomes do not differ at baseline, trained, or acute | Ring arcs: fgsea preranked GSEA on moderated-*t* ranks (Korotkevich et al., [10.1101/060012](https://doi.org/10.1101/060012)) against Hallmark, KEGG, Reactome, GO:BP/CC/MF and GO Slim (MSigDB, Liberzon et al. 2015, [10.1016/j.cels.2015.12.004](https://doi.org/10.1016/j.cels.2015.12.004)), BH-adjusted **within contrast**. Volcano points: π-gated | Sound, with one caveat that must be read: **the arcs and the points are different statistics.** Arcs carry a genuine fgsea BH *q*. Points carry π, which is **not** an FDR. |
...
**The π-score, stated correctly.** π = *p*^\|log2FC\| (Xiao et al. 2014,
[10.1093/bioinformatics/btr671](https://doi.org/10.1093/bioinformatics/btr671)) is the
