...
F04_association_WGCNA module eigengenes, under an elastic net and a sparse PLS regression.
...
The **F04_association_WGCNA module eigengenes were not built inside the cross-validation
...
(`d_mcsa`) predicted from the F04_association_WGCNA module eigengenes under the elastic net, in
...
built, even though its outcome label was never seen. The F04_association_WGCNA eigengenes are
