...
# Exports: sig_sets, dir_map, all_genes, pi_total, fdr_total (used by Panel C)
...
pA <- pA +
  ...
  geom_text(data = label_df,
            ...
            size = scale_text(BASE_COUNT - 1.0, PA_W), fontface = "bold") +
...
write_csv(pi_ci, file.path(DAT, "audit_panel_A_dep_fraction_ci.csv"))

save_panel(pA, file.path(RPT, "panel_A_dep_counts_MAIN"),
           width = PA_W, height = 90)
