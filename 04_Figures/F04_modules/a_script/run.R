...
ggsave(file.path(RPT_DIR, "F04_modules.png"), composite,
  width = 300, height = 340, units = "mm", dpi = 200, bg = "white"
)
ggsave(file.path(RPT_DIR, "F04_modules.pdf"), composite,
...
saveWorkbook(wb, file.path(DAT_DIR, "F04_modules_source_data.xlsx"), overwrite = TRUE)
