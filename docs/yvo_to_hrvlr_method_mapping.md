...
| `F03` volcano rings | How do per-contrast protein- and pathway-level effects look in a consistent visual system? | `04_Figures/F04` | Direct with expansion | Same figure type transfers. HRvLR `F04` should use a main/supp split: 7 main state/within-group contrasts plus 2 supplementary interaction contrasts. Acute subtitles must use `T3 - T2`, not `T3 - T1`. |
